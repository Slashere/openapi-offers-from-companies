    ...
    <div class="flex justify-center">
        <div class="flex-1">
            <div class="border w-auto">
                <div  class="border p-4  font-semibold">Забыли пароль?</div>
                    ...
                    <form class="md:w-10/12 md:p-4 w-full mx-auto" @submit.prevent="send">
                        ...
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center  sm:justify-end">
                            <div class="sm:w-8/12 w-full  flex justify-between items-center mt-3 sm:mt-0">
                                ...
                                <button v-else type="submit" class="p-3 rounded-sm text-white bg-blue-500 hover:bg-blue-600">Выслать email</button>
                                <router-link :to="{name : 'login'}" class="text-sm text-blue-500 hover:underline"> Назад </router-link>
                            </div>
                        </div>
                    </form>
