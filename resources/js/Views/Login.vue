    ...
    <div class="flex justify-center">
        <div class="flex-1">
            <div class="border w-auto">
                <div  class="border p-4  font-semibold">Логин</div>
                ...
                <div class="p-4 bg-white">
                    ...
                    <form class="md:w-10/12 md:p-4 w-full mx-auto" @submit.prevent="login">
                        ...
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center sm:justify-between">
                            <label for="Password" class="w-4/12 "> Пароль </label>
                        ...
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center  sm:justify-end">
                            <div class="sm:w-8/12 w-full  flex justify-between items-center mt-3 sm:mt-0">
                                ...
                                <button v-else type="submit" class="p-3 rounded-sm text-white bg-blue-500 hover:bg-blue-600">Войти</button>
                                <router-link :to="{name : 'register'}" class="text-sm text-blue-500 hover:underline"> Еще не зарегистрирован? Регистрация! </router-link>
                            </div>
                        </div>
                        <div class="w-full my-1 sm:flex sm:justify-end">
                        <router-link :to="{name : 'forgot-password'}" class="text-sm text-gray-500 hover:text-gray-800 hover:underline "> Забыл свой пароль? </router-link>
                        </div>
                    </form>
