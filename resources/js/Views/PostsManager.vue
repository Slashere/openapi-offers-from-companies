            ...
            <b-col>
                <table class="table table-striped">
                    ...
                    <tr v-for="post in filteredPosts" :key="post.id">
                        ...
                        <td class="text-right">
                            <a href="#" @click.prevent="populatePostToEdit(post)"><b-button size="sm"
                                        variant="warning">Edit</b-button></a>
                            <span>&nbsp;</span>
                            <a href="#" @click.prevent="deletePost(post.id)"><b-button size="sm"
                                        variant="danger">Delete</b-button></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <b-col lg="3">
                <b-card :title="(model.id ? 'Edit Post Id: ' + model.id : 'New Post')">
                    <form @submit.prevent="savePost">
                        ...
                        <div>
                            <b-button v-if="model.id" type="button" variant="secondary"
                                      @click.prevent="onCancel">Cancel Edit</b-button>
                        ...
                        <div>
                            <b-modal id="modal-center" ref="confirmModal" centered
                                     title="Delete Confirmation" @ok="handleOk">
...
export default {
    ...
    methods: {
        ...
        async populatePostToEdit(post) {
            // The Object.assign() call copies the value of the post argument rather than the reference. When
